...
describe("Set 003 Card Text Parser Tests - Characters A M", () => {
  ...
  it.skip("Kida - Protector of Atlantis: should parse card text", () => {
    ...
    const perhapsWeCanSaveOurFuture = {
      type: "triggered",
