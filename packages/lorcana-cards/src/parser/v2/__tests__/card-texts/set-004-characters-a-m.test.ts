...
describe("Set 004 Card Text Parser Tests - Characters A M", () => {
  ...
  it.skip("Megara - Liberated One: should parse card text", () => {
    ...
    const peopleAlwaysDoCrazyThings = {
      type: "triggered",
