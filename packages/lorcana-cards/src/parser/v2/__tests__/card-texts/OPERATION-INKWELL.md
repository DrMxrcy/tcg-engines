...
> *"Like ink flowing into the inkwell, we're restructuring the foundation that powers all card abilities."*
...
export const Costs = {
  ...
  Combined: (...costs: AbilityCost[]) => 
    costs.reduce((acc, cost) => ({ ...acc, ...cost }), {}),
};
```
