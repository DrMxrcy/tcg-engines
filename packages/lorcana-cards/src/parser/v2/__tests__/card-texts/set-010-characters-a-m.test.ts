...
describe("Set 010 Card Text Parser Tests - Characters A M", () => {
  ...
  it.skip("Coldstone - Reincarnated Cyborg: should parse card text", () => {
    ...
    const theCantripsHaveBeenSpoken = {
      type: "triggered",
